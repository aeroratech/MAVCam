...
std::pair<Camera::Result, std::vector<Camera::CaptureInfo>> Camera::list_photos(
    PhotosRange photos_range) const {
...
std::ostream &operator<<(std::ostream &str,
                         Camera::Information::CameraCapFlags const &camera_cap_flags) {
