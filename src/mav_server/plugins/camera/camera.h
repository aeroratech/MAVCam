...
// (see https://github.com/GoerLabs/MAVSDK-Proto/blob/main/protos/camera/camera.proto)
...
public:
    /**
     * @brief Constructor. Creates the plugin.
     *
    ...
    struct CaptureInfo {
        ...
        Quaternion
            attitude_quaternion{}; /**< @brief Attitude of the camera when the picture was taken (quaternion) */
        EulerAngle
            attitude_euler_angle{}; /**< @brief Attitude of the camera when the picture was taken (euler angle) */
     ...
     */
        ...
        float
            recording_time_s{}; /**< @brief Elapsed time since starting the video recording (in seconds) */
    ...
    struct Setting {
        ...
        std::string
            setting_description{}; /**< @brief Description of the setting (human readable). This field is meant to be read from the drone, ignore it when setting. */
        Option option{};           /**< @brief Selected option */
        bool
            is_range{}; /**< @brief If option is given as a range. This field is meant to be read from the drone, ignore it when setting. */
    };
     ...
     */
        enum class CameraCapFlags {
            ...
            CanCaptureVideoInImageMode, /**< @brief Camera can capture videos while in Photo/Image mode. */
            ...
            HasTrackingRectangle, /**< @brief Camera supports tracking of a selection rectangle on the. */
     ...
     */
        ...
        std::string
            firmware_version{}; /**< @brief Camera firmware version in major[.minor[.patch[.dev]]] format */
